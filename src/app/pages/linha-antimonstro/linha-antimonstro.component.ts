...
import { Router, RouterLink } from '@angular/router'; // Importado o Router aqui
...
import { CarrinhoService } from '../../componentes/services/carrinho.service'; // Importado o CarrinhoService
